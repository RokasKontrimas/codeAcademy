            ...
            <div className="container-wrap">
                    ...
                    <div className="user">
                        <div className="user-image-wrapper">
                            <img className="user-image"
                                 src={'https://github.com/frontendmentorio/testimonials-grid-section/blob/main/images/image-daniel.jpg?raw=true'}
                                 alt="Daniel"/>
                        </div>
                ...
                <div className="container container-2">
                    <div className="user">
                        <div className="user-image-wrapper">
                            <img className="user-image"
                                 src={'https://github.com/frontendmentorio/testimonials-grid-section/blob/main/images/image-jonathan.jpg?raw=true'}
                                 alt="Jonathan"/>
                        </div>
                        <div className="user-credentials">
                ...
                <div className="container container-3">
                    <div className="user">
                        <div className="user-image-wrapper">
                            <img className="user-image"
                                 src={'https://github.com/frontendmentorio/testimonials-grid-section/blob/main/images/image-kira.jpg?raw=true'}
                                 alt="Kira"/>
                        </div>
                        <div className="user-credentials">
                            <h3>Kira Whittle</h3>
                    ...
                    <div className="description-content">
                        ...
                        <p> “ Before joining the bootcamp, I’ve never written a line of code. I needed some structure
                            from
                ...
                <div className="container container-4">
                    <div className="user">
                        <div className="user-image-wrapper">
                            <img className="user-image"
                                 src={'https://github.com/frontendmentorio/testimonials-grid-section/blob/main/images/image-jeanette.jpg?raw=true'}
                                 alt="Jeanette"/>
                        </div>
                        <div className="user-credentials">
                ...
                <div className="container container-5">
                    <div className="user">
                        <div className="user-image-wrapper">
                            <img className="user-image"
                                 src={'https://github.com/frontendmentorio/testimonials-grid-section/blob/main/images/image-patrick.jpg?raw=true'}
                                 alt="Patrick"/>
                        </div>
                        <div className="user-credentials">
